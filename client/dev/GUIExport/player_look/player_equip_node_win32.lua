...
function ui.init(parent, __data__, __update__)
	...
	-- Create Best_ringBox
	local Best_ringBox = GUI:Layout_Create(Panel_1, "Best_ringBox", 227, 230, 43, 36, false)
	GUI:setChineseName(Best_ringBox, "玩家装备_首饰盒组合")
	GUI:setAnchorPoint(Best_ringBox, 0.00, 0.00)
	GUI:setTouchEnabled(Best_ringBox, true)
	GUI:setTag(Best_ringBox, 0)

	-- Create Image_box
	local Image_box = GUI:Image_Create(Best_ringBox, "Image_box", 0, 0, "res/private/player_best_rings_ui/player_best_rings_ui_mobile/btn_jewelry_1_0.png")
	GUI:setAnchorPoint(Image_box, 0.00, 0.00)
	GUI:setTouchEnabled(Image_box, false)
	GUI:setTag(Image_box, 0)

	-- Create Wx_Btn
	local Wx_Btn = GUI:Button_Create(Panel_1, "Wx_Btn", 1, 154, "res/custom/play_model/wx_bt.png")
	...
	-- Create magicRingBtn
	local magicRingBtn = GUI:Button_Create(Panel_1, "magicRingBtn", 1, 181, "res/custom/npc/69mj/an.png")
	...
	-- Create FeiJianBtn
	local FeiJianBtn = GUI:Button_Create(Panel_1, "FeiJianBtn", 223, 278, "res/custom/npc/111kfsc/fjbtn.png")
	GUI:setContentSize(FeiJianBtn, 60, 28)
	GUI:setIgnoreContentAdaptWithSize(FeiJianBtn, false)
