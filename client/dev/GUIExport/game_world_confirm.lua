...
function ui.init(parent)
	...
	local ContentLayout = GUI:Layout_Create(ConfirmBG, "ContentLayout", 289.00, 536.00, 300.00, 456.00, false)
	...
	local ConfirmButton = GUI:Button_Create(ConfirmBG, "ConfirmButton", 279.00, 189.00, "res/private/announce/00000361.png")
	...
	local RemainingText = GUI:Text_Create(ConfirmBG, "RemainingText", 348.00, 191.00, 18, "#ffffff", [[(3)]])
