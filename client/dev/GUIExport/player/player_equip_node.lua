...
function ui.init(parent, __data__, __update__)
	...
	local Text_guildinfo = GUI:Text_Create(Panel_1, "Text_guildinfo", 10, 460, 18, "#ffffff", [[]])
	...
	GUI:setTouchEnabled(Image_box, true)
	...
	-- Create FeiJianBtn
	local FeiJianBtn = GUI:Button_Create(Panel_1, "FeiJianBtn", 284, 419, "res/custom/npc/111kfsc/fjbtn.png")
