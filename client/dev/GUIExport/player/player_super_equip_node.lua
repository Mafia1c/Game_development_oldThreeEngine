...
function ui.init(parent, __data__, __update__)
	...
	-- Create Panel_pos17
	local Panel_pos17 = GUI:Layout_Create(Panel_1, "Panel_pos17", 174, 197, 180, 240, false)
	...
	TAGOBJ["32"] = Panel_pos17

	-- Create Panel_pos21
	local Panel_pos21 = GUI:Layout_Create(Panel_1, "Panel_pos21", 174, 322, 50, 50, false)
	...
	-- Create Panel_pos45
	local Panel_pos45 = GUI:Layout_Create(Panel_1, "Panel_pos45", 244, 208, 85, 140, false)
	...
	-- Create Panel_pos18
	local Panel_pos18 = GUI:Layout_Create(Panel_1, "Panel_pos18", 67, 306, 120, 206, false)
	...
	local Panel_pos1019 = GUI:Layout_Create(Panel_1, "Panel_pos1019", 314, 397, 51, 51, false)
	...
	TAGOBJ["34"] = Panel_pos1019

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_pos1019, "Image_bg", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_pos1019, "Image_icon", 25, 25, "res/public/0.png")
	...
	local Panel_pos1021 = GUI:Layout_Create(Panel_1, "Panel_pos1021", 314, 337, 51, 51, false)
	...
	TAGOBJ["34"] = Panel_pos1021

	-- Create Image_bg
	Image_bg = GUI:Image_Create(Panel_pos1021, "Image_bg", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	GUI:Image_setScale9Slice(Image_bg, 0, 0, 0, 0)
	GUI:setContentSize(Image_bg, 52, 52)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	...
	-- Create Image_icon
	Image_icon = GUI:Image_Create(Panel_pos1021, "Image_icon", 25, 25, "res/public/0.png")
	...
	local Panel_pos1018 = GUI:Layout_Create(Panel_1, "Panel_pos1018", 36, 276, 51, 51, false)
	...
	TAGOBJ["34"] = Panel_pos1018

	-- Create Image_bg
	Image_bg = GUI:Image_Create(Panel_pos1018, "Image_bg", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	GUI:Image_setScale9Slice(Image_bg, 0, 0, 0, 0)
	GUI:setContentSize(Image_bg, 52, 52)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	...
	-- Create Image_icon
	Image_icon = GUI:Image_Create(Panel_pos1018, "Image_icon", 25, 25, "res/public/0.png")
	...
	local Panel_pos1017 = GUI:Layout_Create(Panel_1, "Panel_pos1017", 36, 216, 51, 51, false)
	...
	TAGOBJ["34"] = Panel_pos1017

	-- Create Image_bg
	Image_bg = GUI:Image_Create(Panel_pos1017, "Image_bg", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	GUI:Image_setScale9Slice(Image_bg, 0, 0, 0, 0)
	GUI:setContentSize(Image_bg, 52, 52)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	...
	-- Create Image_icon
	Image_icon = GUI:Image_Create(Panel_pos1017, "Image_icon", 25, 25, "res/public/0.png")
	...
	-- Create Panel_pos23
	local Panel_pos23 = GUI:Layout_Create(Panel_1, "Panel_pos23", 36, 156, 51, 51, false)
	...
	-- Create Image_bg
	Image_bg = GUI:Image_Create(Panel_pos23, "Image_bg", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/icon_chenghd_03.png")
	...
	-- Create Image_icon
	Image_icon = GUI:Image_Create(Panel_pos23, "Image_icon", 25, 25, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/1900015034.png")
	...
	-- Create Panel_pos25
	local Panel_pos25 = GUI:Layout_Create(Panel_1, "Panel_pos25", 36, 95, 51, 51, false)
	...
	-- Create Panel_pos24
	local Panel_pos24 = GUI:Layout_Create(Panel_1, "Panel_pos24", 314, 95, 51, 51, false)
	...
	-- Create Panel_pos22
	local Panel_pos22 = GUI:Layout_Create(Panel_1, "Panel_pos22", 314, 156, 51, 51, false)
	...
	-- Create Panel_pos26
	local Panel_pos26 = GUI:Layout_Create(Panel_1, "Panel_pos26", 314, 216, 51, 51, false)
	...
	-- Create Panel_pos20
	local Panel_pos20 = GUI:Layout_Create(Panel_1, "Panel_pos20", 314, 277, 51, 51, false)
	...
	-- Create Panel_pos44
	local Panel_pos44 = GUI:Layout_Create(Panel_1, "Panel_pos44", 36, 35, 51, 51, false)
	...
	-- Create Panel_pos42
	local Panel_pos42 = GUI:Layout_Create(Panel_1, "Panel_pos42", 314, 35, 51, 51, false)
	...
	-- Create Panel_pos29
	local Panel_pos29 = GUI:Layout_Create(Panel_1, "Panel_pos29", 257, 35, 51, 51, false)
	...
	-- Create Panel_pos28
	local Panel_pos28 = GUI:Layout_Create(Panel_1, "Panel_pos28", 203, 35, 51, 51, false)
	...
	-- Create Panel_pos27
	local Panel_pos27 = GUI:Layout_Create(Panel_1, "Panel_pos27", 147, 35, 51, 51, false)
	...
	-- Create Panel_pos43
	local Panel_pos43 = GUI:Layout_Create(Panel_1, "Panel_pos43", 92, 35, 51, 51, false)
	...
	-- Create Node_1019
	local Node_1019 = GUI:Node_Create(Panel_1, "Node_1019", 314, 397)
	...
	-- Create Node_1021
	local Node_1021 = GUI:Node_Create(Panel_1, "Node_1021", 314, 337)
	...
	-- Create Node_1018
	local Node_1018 = GUI:Node_Create(Panel_1, "Node_1018", 36, 276)
	...
	-- Create Node_1017
	local Node_1017 = GUI:Node_Create(Panel_1, "Node_1017", 36, 216)
	...
	TAGOBJ["352"] = Text_shizhuang

	-- Create CheckBox_shizhuang
	local CheckBox_shizhuang = GUI:CheckBox_Create(Panel_1, "CheckBox_shizhuang", 250, 453, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	TAGOBJ["351"] = CheckBox_shizhuang

	-- Create luckEquipBtn
	local luckEquipBtn = GUI:Button_Create(Panel_1, "luckEquipBtn", 316, 410, "res/custom/fuBtn.png")
	GUI:Button_setTitleText(luckEquipBtn, [[]])
	GUI:Button_setTitleColor(luckEquipBtn, "#ffffff")
	GUI:Button_setTitleFontSize(luckEquipBtn, 14)
	GUI:Button_titleEnableOutline(luckEquipBtn, "#000000", 1)
	GUI:setAnchorPoint(luckEquipBtn, 0.50, 0.50)
	GUI:setTouchEnabled(luckEquipBtn, true)
	GUI:setTag(luckEquipBtn, -1)
