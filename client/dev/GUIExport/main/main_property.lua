...
function ui.init(parent)
	...
	-- Create bottomImg
	local bottomImg = GUI:Image_Create(Panel_bg, "bottomImg", 408.00 + 218, -3.00, "res/private/main/1900012003.png")
	GUI:setContentSize(bottomImg, 1536, 30)
	GUI:setIgnoreContentAdaptWithSize(bottomImg, false)
	GUI:setChineseName(bottomImg, "主界面操作_底部栏_背景图")
	GUI:setAnchorPoint(bottomImg, 0.42, 0.00)
