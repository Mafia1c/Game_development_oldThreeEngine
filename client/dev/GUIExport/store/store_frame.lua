...
function ui.init(parent)
	...
	GUI:Win_SetParam(page_cell_1, {grey = 1}, "Button")
...
销]])
	...
	GUI:Win_SetParam(page_cell_2, {grey = 1}, "Button")
...
给]])
	...
	GUI:Win_SetParam(page_cell_3, {grey = 1}, "Button")
...
化]])
	...
	GUI:Win_SetParam(page_cell_4, {grey = 1}, "Button")
	GUI:setChineseName(page_cell_4, "商店框架_技能组合")
	GUI:setTouchEnabled(page_cell_4, false)
	GUI:setTag(page_cell_4, -1)

	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_4, "PageText", 13.00, 56.00, 16, "#807256", [[兑
换]])
