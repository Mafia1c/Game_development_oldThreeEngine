...
function ui.init(parent)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_main, "Button_close", 284.00, 260.00, "res/public/1900000510.png")
	...
	-- Create Node_btn
	local Node_btn = GUI:Node_Create(Panel_main, "Node_btn", 181.00, 81.00)
	GUI:setChineseName(Node_btn, "宝箱_按钮特效_节点")
	GUI:setAnchorPoint(Node_btn, 0.50, 0.50)
	GUI:setTag(Node_btn, 92)

	-- Create Button_open
	local Button_open = GUI:Button_Create(Panel_main, "Button_open", 181.00, 76.00, "res/private/treasure_box/000511.png")
	...
	GUI:Button_setScale9Slice(Button_open, 32, 32, 13, 14)
	GUI:setContentSize(Button_open, 96, 40)
	...
	GUI:Win_SetParam(Button_open, {grey = 1}, "Button")
