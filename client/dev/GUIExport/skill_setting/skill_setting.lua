...
function ui.init(parent)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 12.00, 16.00, "res/public/1900000610.png")
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 104.00, 491.00, 20, "#d8c8ae", [[]])
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(FrameLayout, "CloseButton", 793.00, 511.00, "res/public/1900000510.png")
	...
	GUI:Win_SetParam(Button_restore_basic, {grey = 1}, "Button")
	...
	GUI:Win_SetParam(Button_cleanup, {grey = 1}, "Button")
