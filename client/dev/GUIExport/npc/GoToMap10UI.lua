...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/94dt/bg2_1.png")
	...
	-- Create enterMapBtn
	local enterMapBtn = GUI:Button_Create(FrameLayout, "enterMapBtn", 490, 44, "res/custom/npc/94dt/an1.png")
	...
	GUI:Button_setTitleColor(enterMapBtn, "#00ff00")
	...
	-- Create iconImg
	local iconImg = GUI:Image_Create(FrameLayout, "iconImg", 461, 430, "res/custom/npc/94dt/icon2_1.png")
	GUI:setContentSize(iconImg, 194, 54)
