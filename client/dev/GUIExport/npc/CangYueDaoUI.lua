...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/54dt/cyd.png")
	...
	-- Create enterMapBtn
	local enterMapBtn = GUI:Button_Create(FrameLayout, "enterMapBtn", 415, 36, "res/custom/npc/54dt/an.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(FrameLayout, "Text_1", 347, 107, 18, "#ff0000", [[三合开启 + 10转]])
