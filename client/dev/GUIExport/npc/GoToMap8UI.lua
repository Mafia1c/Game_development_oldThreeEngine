...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/63mlc/01smzl.png")
	...
	-- Create joinBtn
	local joinBtn = GUI:Button_Create(FrameLayout, "joinBtn", 575, 85, "res/custom/npc/54dt/an.png")
	GUI:setContentSize(joinBtn, 130, 42)
