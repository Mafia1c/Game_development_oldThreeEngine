...
function ui.init(parent, __data__, __update__)
	...
	-- Create EquipShow_1
	local EquipShow_1 = GUI:ItemShow_Create(FrameLayout, "EquipShow_1", 58, 372, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(EquipShow_1, 0.50, 0.50)
	GUI:setTag(EquipShow_1, 0)

	-- Create EquipShow_2
	local EquipShow_2 = GUI:ItemShow_Create(FrameLayout, "EquipShow_2", 322, 372, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(EquipShow_2, 0.50, 0.50)
	GUI:setTag(EquipShow_2, 0)

	-- Create EquipShow_3
	local EquipShow_3 = GUI:ItemShow_Create(FrameLayout, "EquipShow_3", 58, 214, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(EquipShow_3, 0.50, 0.50)
	GUI:setTag(EquipShow_3, 0)

	-- Create EquipShow_4
	local EquipShow_4 = GUI:ItemShow_Create(FrameLayout, "EquipShow_4", 322, 213, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(EquipShow_4, 0.50, 0.50)
	GUI:setTag(EquipShow_4, 0)

	-- Create EquipShow_5
	local EquipShow_5 = GUI:ItemShow_Create(FrameLayout, "EquipShow_5", 194, 111, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
