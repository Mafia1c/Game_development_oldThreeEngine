...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/70ah/bg4.png")
	...
	-- Create blInfo
	local blInfo = GUI:Node_Create(FrameLayout, "blInfo", 282, 94)
	GUI:setTag(blInfo, 0)
	...
	-- Create closeBtn
	local closeBtn = GUI:Button_Create(FrameLayout, "closeBtn", 819, 482, "res/public/1900000510.png")
	...
	-- Create joinBtn
	local joinBtn = GUI:Button_Create(FrameLayout, "joinBtn", 594, 59, "res/custom/npc/54dt/an.png")
