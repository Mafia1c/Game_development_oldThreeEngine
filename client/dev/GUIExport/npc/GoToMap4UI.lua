...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/54dt/bg11.png")
	...
	-- Create enterGB1Btn
	local enterGB1Btn = GUI:Button_Create(FrameLayout, "enterGB1Btn", 590, 97, "res/custom/npc/54dt/an3.png")
	GUI:setContentSize(enterGB1Btn, 106, 36)
	GUI:setIgnoreContentAdaptWithSize(enterGB1Btn, false)
	GUI:Button_setTitleText(enterGB1Btn, [[]])
	GUI:Button_setTitleColor(enterGB1Btn, "#ffffff")
	GUI:Button_setTitleFontSize(enterGB1Btn, 16)
	...
	-- Create enterGB2Btn
	local enterGB2Btn = GUI:Button_Create(FrameLayout, "enterGB2Btn", 590, 51, "res/custom/npc/54dt/an4.png")
	GUI:setContentSize(enterGB2Btn, 106, 36)
	GUI:setIgnoreContentAdaptWithSize(enterGB2Btn, false)
	GUI:Button_setTitleText(enterGB2Btn, [[]])
	GUI:Button_setTitleColor(enterGB2Btn, "#ffffff")
	GUI:Button_setTitleFontSize(enterGB2Btn, 16)
