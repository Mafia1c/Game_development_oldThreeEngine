...
function ui.init(parent, __data__, __update__)
	...
	-- Create EquipShow_1
	local EquipShow_1 = GUI:EquipShow_Create(FrameLayout, "EquipShow_1", 58, 372, 71, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_2
	local EquipShow_2 = GUI:EquipShow_Create(FrameLayout, "EquipShow_2", 322, 371, 72, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_3
	local EquipShow_3 = GUI:EquipShow_Create(FrameLayout, "EquipShow_3", 58, 283, 73, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_4
	local EquipShow_4 = GUI:EquipShow_Create(FrameLayout, "EquipShow_4", 323, 283, 74, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_5
	local EquipShow_5 = GUI:EquipShow_Create(FrameLayout, "EquipShow_5", 58, 195, 117, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_6
	local EquipShow_6 = GUI:EquipShow_Create(FrameLayout, "EquipShow_6", 322, 195, 118, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_7
	local EquipShow_7 = GUI:EquipShow_Create(FrameLayout, "EquipShow_7", 58, 107, 119, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
	...
	-- Create EquipShow_8
	local EquipShow_8 = GUI:EquipShow_Create(FrameLayout, "EquipShow_8", 322, 108, 120, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = false, starLv = false, lookPlayer = false, showModelEffect = false})
