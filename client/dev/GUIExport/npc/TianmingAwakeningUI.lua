...
function ui.init(parent, __data__, __update__)
	...
	-- Create closeBtn
	local closeBtn = GUI:Button_Create(FrameLayout, "closeBtn", 822, 480, "res/public/1900000510.png")
	...
	-- Create AwakeningBtn
	local AwakeningBtn = GUI:Button_Create(FrameLayout, "AwakeningBtn", 652, 39, "res/custom/npc/49tmgg/an.png")
	...
	-- Create successRate
	local successRate = GUI:Text_Create(FrameLayout, "successRate", 652, 79, 18, "#ffffff", [[成功几率:  11%]])
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(FrameLayout, "Image_1", 393, 47, "res/custom/npc/49tmgg/tip1.png")
	GUI:setAnchorPoint(Image_1, 0.00, 0.00)
	GUI:setTouchEnabled(Image_1, false)
	GUI:setTag(Image_1, 0)

	-- Create needItem_1
	local needItem_1 = GUI:ItemShow_Create(FrameLayout, "needItem_1", 471, 67, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(needItem_1, 0.50, 0.50)
	GUI:setTag(needItem_1, 0)

	-- Create needItem_2
	local needItem_2 = GUI:ItemShow_Create(FrameLayout, "needItem_2", 535, 67, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(needItem_2, 0.50, 0.50)
	GUI:setTag(needItem_2, 0)

	-- Create needItem_3
	local needItem_3 = GUI:ItemShow_Create(FrameLayout, "needItem_3", 599, 67, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(needItem_3, 0.50, 0.50)
	GUI:setTag(needItem_3, 0)

	-- Create titleTips_1
	local titleTips_1 = GUI:Text_Create(FrameLayout, "titleTips_1", 83, 43, 18, "#00ff00", [[觉醒全套
即可获得]])
	...
	-- Create giveItem
	local giveItem = GUI:ItemShow_Create(FrameLayout, "giveItem", 198, 67, {index = 1, count = 1, look = true, bgVisible = true, color = 255})
	GUI:setAnchorPoint(giveItem, 0.50, 0.50)
	GUI:setTag(giveItem, 0)

	-- Create titleTips_2
	local titleTips_2 = GUI:Text_Create(FrameLayout, "titleTips_2", 247, 43, 18, "#9b00ff", [[每激活一个根骨:
生命加成+2%]])
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(FrameLayout, "Image_2", 171, 178, "res/custom/npc/49tmgg/tip2.png")
	GUI:setAnchorPoint(Image_2, 0.00, 0.00)
	GUI:setTouchEnabled(Image_2, false)
	GUI:setTag(Image_2, 0)

	-- Create Image_3
	local Image_3 = GUI:Image_Create(FrameLayout, "Image_3", 471, 179, "res/custom/npc/49tmgg/tip3.png")
	GUI:setAnchorPoint(Image_3, 0.00, 0.00)
	GUI:setTouchEnabled(Image_3, false)
	GUI:setTag(Image_3, 0)

	-- Create effNode
	local effNode = GUI:Node_Create(FrameLayout, "effNode", 436, 448)
	GUI:setTag(effNode, 0)

	-- Create Button_1
	local Button_1 = GUI:Button_Create(FrameLayout, "Button_1", 87, 397, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_5
	local Button_5 = GUI:Button_Create(FrameLayout, "Button_5", 87, 338, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_6
	local Button_6 = GUI:Button_Create(FrameLayout, "Button_6", 87, 279, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_9
	local Button_9 = GUI:Button_Create(FrameLayout, "Button_9", 87, 216, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_10
	local Button_10 = GUI:Button_Create(FrameLayout, "Button_10", 87, 160, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(FrameLayout, "Button_2", 657, 397, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(FrameLayout, "Button_3", 657, 338, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_4
	local Button_4 = GUI:Button_Create(FrameLayout, "Button_4", 657, 279, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_7
	local Button_7 = GUI:Button_Create(FrameLayout, "Button_7", 657, 216, "res/custom/npc/49tmgg/an.png")
	...
	-- Create Button_8
	local Button_8 = GUI:Button_Create(FrameLayout, "Button_8", 657, 160, "res/custom/npc/49tmgg/an.png")
	...
	-- Create CheckBox_1
	local CheckBox_1 = GUI:CheckBox_Create(FrameLayout, "CheckBox_1", 294, 122, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(FrameLayout, "Text_1", 325, 123, 18, "#ffff00", [[勾选使用幸运符, 可增加10%的几率]])
