...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameLayout
	local FrameLayout = GUI:Layout_Create(parent, "FrameLayout", _V("SCREEN_WIDTH") * 0.5, _V("SCREEN_HEIGHT") * 0.5, 738, 404, false)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/01ditu/bg1.png")
	GUI:Image_setScale9Slice(FrameBG, 73, 73, 134, 134)
	GUI:setContentSize(FrameBG, 738, 404)
	...
	-- Create miniMapImg
	local miniMapImg = GUI:Image_Create(FrameLayout, "miniMapImg", 288, 239, "scene/uiminimap/000305.png")
	GUI:setContentSize(miniMapImg, 516, 341)
	...
	-- Create mapName
	local mapName = GUI:Text_Create(FrameLayout, "mapName", 563, 329, 18, "#ff9b00", [[火龙巢穴]])
	...
	-- Create baoLvTitle
	local baoLvTitle = GUI:Text_Create(FrameLayout, "baoLvTitle", 568, 194, 18, "#ff9b00", [[部分爆率展示]])
	...
	-- Create mapInfo
	local mapInfo = GUI:Node_Create(FrameLayout, "mapInfo", 560, 274)
	...
	-- Create blInfo
	local blInfo = GUI:Node_Create(FrameLayout, "blInfo", 564, 152)
	GUI:setTag(blInfo, 0)
	...
	-- Create bottomInfo
	local bottomInfo = GUI:Node_Create(FrameLayout, "bottomInfo", 414, 57)
	...
	-- Create enterGBBtn
	local enterGBBtn = GUI:Button_Create(FrameLayout, "enterGBBtn", 435, 30, "res/custom/npc/01ditu/an.png")
	...
	-- Create enterMapBtn
	local enterMapBtn = GUI:Button_Create(FrameLayout, "enterMapBtn", 579, 30, "res/custom/npc/01ditu/an.png")
	...
	-- Create closeBtn
	local closeBtn = GUI:Button_Create(FrameLayout, "closeBtn", 739, 362, "res/public/1900000510.png")
	...
	-- Create btnPage
	local btnPage = GUI:ScrollView_Create(FrameLayout, "btnPage", 16, 25, 138, 342, 1)
	GUI:ScrollView_setBounceEnabled(btnPage, true)
	GUI:ScrollView_setInnerContainerSize(btnPage, 138.00, 362.00)
	GUI:setAnchorPoint(btnPage, 0.00, 0.00)
	GUI:setTouchEnabled(btnPage, true)
	GUI:setTag(btnPage, 0)

	-- Create gaobaoLayout
	local gaobaoLayout = GUI:Layout_Create(FrameLayout, "gaobaoLayout", -196, -120, 1136, 640, false)
	GUI:setAnchorPoint(gaobaoLayout, 0.00, 0.00)
