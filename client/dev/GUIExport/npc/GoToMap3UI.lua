...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/54dt/bg1.png")
	...
	-- Create bottomInfo
	local bottomInfo = GUI:Node_Create(FrameLayout, "bottomInfo", 476, 106)
	GUI:setTag(bottomInfo, 0)

	-- Create enterMapBtn
	local enterMapBtn = GUI:Button_Create(FrameLayout, "enterMapBtn", 572, 83, "res/custom/npc/54dt/an.png")
