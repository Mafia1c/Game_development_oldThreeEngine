...
function ui.init(parent, __data__, __update__)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(FrameLayout, "FrameBG", 0, 0, "res/custom/npc/54dt/zmt.png")
	...
	-- Create blInfo
	local blInfo = GUI:Node_Create(FrameLayout, "blInfo", 535, 186)
	GUI:setTag(blInfo, 0)
	...
	-- Create enterBtn
	local enterBtn = GUI:Button_Create(FrameLayout, "enterBtn", 358, 44, "res/custom/npc/54dt/an1.png")
	...
	-- Create enterKfBtn
	local enterKfBtn = GUI:Button_Create(FrameLayout, "enterKfBtn", 544, 44, "res/custom/npc/54dt/an2.png")
	...
	-- Create closeBtn
	local closeBtn = GUI:Button_Create(FrameLayout, "closeBtn", 683, 370, "res/custom/npc/54dt/sc_close.png")
	...
	-- Create rewardBtn
	local rewardBtn = GUI:Button_Create(FrameLayout, "rewardBtn", 260, 59, "res/custom/npc/54dt/yulan.png")
	GUI:setContentSize(rewardBtn, 66, 50)
	GUI:setIgnoreContentAdaptWithSize(rewardBtn, false)
	GUI:Button_setTitleText(rewardBtn, [[]])
	GUI:Button_setTitleColor(rewardBtn, "#ffffff")
	GUI:Button_setTitleFontSize(rewardBtn, 16)
	GUI:Button_titleEnableOutline(rewardBtn, "#000000", 1)
	GUI:setAnchorPoint(rewardBtn, 0.00, 0.00)
