local config = {
    ...
    {page = 1, index = 2,  Command = "@gm_setsysvar 变量名 变量值 变量值类型", title = "设置系统变量", default = "4#integer", selectList = "4#integer^string^table#数字型^字符型^table型"},
    ...
    --//玩家
    {page = 2, index = 1,  Command = "@gm_getplayvar 玩家名 变量名 变量值类型", title = "获取玩家变量",pageName = "玩家", default = "2##USER_NAME|4#integer", selectList = "4#integer^string#数字型^字符型"},
    {page = 2, index = 2,  Command = "@gm_setplayvar 玩家名 变量名 变量值 变量值类型", title = "设置玩家变量",default = "2##USER_NAME|5#integer", selectList = "5#integer^string^table#数字型^字符型^table型"},
    {page = 2, index = 3,  Command = "@gm_getplayvarex 玩家名 天变量名 变量值类型", title = "获取玩家天变量", default = "2##USER_NAME|4#integer", selectList = "4#integer^string#数字型^字符型"},
    {page = 2, index = 4,  Command = "@gm_setplayvarex 玩家名 天变量名 变量值 变量值类型", title = "设置玩家天变量", default = "2##USER_NAME|5#integer", selectList = "5#integer^string^table#数字型^字符型^table型"},
    ...
    {page = 2, index = 16, Command = "@gm_setlevel 玩家名 等级", title = "设置玩家等级", default="2##USER_NAME"},
    {page = 2, index = 17, Command = "@gm_setrelevel 玩家名 转生等级", title = "设置玩家转生等级", default="2##USER_NAME"},
    {page = 2, index = 18, Command = "@gm_getcurrency 玩家名 货币名称", title = "获得玩家货币数量", default="2##USER_NAME"},
    {page = 2, index = 19, Command = "@gm_setcurrency 玩家名 货币名称 货币数量", title = "设置玩家货币数量", default="2##USER_NAME"},
    {page = 2, index = 20, Command = "@gm_setgmlevel 玩家名 权限值", title = "设置玩家gm权限", default = "2##USER_NAME"},
    ...
    -- 成套装备
    {page = 12, index = 1,  Command = "@gm_giveequips 玩家名 装备系列名称", title = "发送成套装备(参考回收装备系列)", pageName = "成套装备", default="2##USER_NAME"},
}
return config