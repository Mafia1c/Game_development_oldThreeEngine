...
function PlayerSuperEquip_Look.main(data)
    ...
    -- 初始化自定义按钮事件
    PlayerSuperEquip_Look.InitOtherBtnEvent()
...
--#region 自定义按钮事件
function PlayerSuperEquip_Look.InitOtherBtnEvent()
    local luckEquipBtn = PlayerSuperEquip_Look._ui.luckEquipBtn --#region 福装备
    --#region 福装备
    if luckEquipBtn then
        GUI:addOnClickEvent(luckEquipBtn,function()
            SendMsgClickSysBtn("_lookEquip#OtherSysFunc#lookPlayerInfo#4")
        end)
    end
end
